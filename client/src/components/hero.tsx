            ...
            <div className="container mx-auto flex flex-col md:flex-row items-center justify-center text-center md:text-left sm:pl-10 gap-12">
                ...
                >
                    <div className="w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full overflow-hidden shadow-2xl border-4 border-pale-gold">
                        ...
                        {/* You might want to replace "/AmbuSpeech.jpeg" with a path to your actual profile picture */}
                        <img src="/TanuFormal.jpeg" alt="Tanu Shree Kumawat Profile" className="w-full h-full object-cover" />
                    </div>
                </motion.div>
                ...
                >
                    <h1 className="text-pale-gold text-5xl sm:text-6xl md:text-6xl font-extrabold leading-tight mb-4 drop-shadow-xl">Hi, I'm <span className="text-inherit">Tanu Shree Kumawat</span></h1>
                    <p className="text-lg sm:text-xl leading-relaxed mb-8">
                        A passionate Computer Science engineer specializing in Computer Vision, Machine Learning, and Robotics.
                        I bring innovative solutions to complex problems, backed by experience in developing autonomous systems and AI-powered applications.
                    </p>
