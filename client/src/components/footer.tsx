    ...
    >
        <div className="container mx-auto px-4">
            ...
            <div className="flex justify-center space-x-6 mt-4">
                <a href="https://github.com/Catnip-01" target="_blank" rel="noopener noreferrer" className="hover:text-pale-gold transition-colors">
                ...
                <a href="https://linkedin.com/in/shantanu-pandey-rit" target="_blank" rel="noopener noreferrer" className="hover:text-pale-gold transition-colors">
                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                ...
                <a href="https://leetcode.com/u/Shantanu_Pandey/" target="_blank" rel="noopener noreferrer" className="hover:text-pale-gold transition-colors">
