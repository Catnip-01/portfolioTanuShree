...
const ThemeToggle = () => {
    ...
    return (
        <motion.button onClick={toggleTheme} className="p-2 rounded-full shadow-md focus:outline-none transition-colors duration-300   bg-neutral-bg   text-pale-gold   shadow-md" whileHover={{ scale: 1.1, rotate: 15 }} whileTap={{ scale: 0.9 }}>
